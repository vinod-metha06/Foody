  ...
  const dat = [
    {
      ...
      ins: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Convallis a cras semper auctor neque. Enim praesent elementum facilisis leo vel fringilla est ullamcorper eget. Enim lobortis scelerisque fermentum dui faucibus. Odio euismod lacinia at quis risus sed vulputate odio.',
      rating: 4,
      img: 'https://bit.ly/3UHnaLs',
      ind : ['rice', 'milk','ghee','sugar','salt','peper'],
    },
    {
      id: 2,
      name: 'Sugar - Palm',
